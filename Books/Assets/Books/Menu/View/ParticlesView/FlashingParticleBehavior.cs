...
namespace Books.Menu.View.ParticlesView
{
    public class FlashingParticleBehavior : ParticleBehavior
    {
        ...
        [Range(1, 5)] [SerializeField] private float _flashCycleDuration;
        ...
        public override void ActivateAnimation(Action callback = null)
        {
            ...
            if (_useStartFadeAsMax)
                _maxFadeValue = startFade;
            ...
            {
                Debug.Log($"Необходимо снизить долю времени появления и угасания. Прололжительность мерцания равна 0 у объекта {gameObject.name}");
            ...
            Sequence.Insert(duration * fadeInPercentage, _flashingSequence);
            Sequence.Play();
        }
