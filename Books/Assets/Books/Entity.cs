        ...
        private async UniTask AsyncProcess()
        {
            ...
            var wardrobe = new Wardrobe.Entity(new Wardrobe.Entity.Ctx
            {
                ...
                TestData = new Wardrobe.Entity.TestData(
                    new []{"Персонажи/ГГ/Одежда/Вода/Краса морская/2.png", "Персонажи/ГГ/Одежда/Вода/Краса морская/6.png", "Персонажи/ГГ/Одежда/Вода/Наряд1/1.png", "Персонажи/ГГ/Одежда/Вода/Наряд1/2.png", "Персонажи/ГГ/Одежда/Вода/Наряд1/4.png", "Персонажи/ГГ/Одежда/Суша/Клуб/1.png", "Персонажи/ГГ/Одежда/Суша/Бар/1.png", "Персонажи/ГГ/Одежда/Вода/Житель Атлантиды-/1.png"},
                    new []{"Персонажи/ГГ/Причёски/Суша/Вперёд/Бант/Рыжий.png", "Персонажи/ГГ/Причёски/Суша/Вперёд/Бант/Светлый.png", "Персонажи/ГГ/Причёски/Суша/Вперёд/Бант/Каштан.png", "Персонажи/ГГ/Причёски/Суша/Вперёд/Бант/Розовый.png", "Персонажи/ГГ/Причёски/Вода/Назад/Прическа1/Чёрный.png", "Персонажи/ГГ/Причёски/Вода/Назад/Прическа1/Блонд.png", "Персонажи/ГГ/Причёски/Вода/Назад/Прическа1/Каштан.png", "Персонажи/ГГ/Причёски/Вода/Назад/Сирена/Рыжий.png", "Персонажи/ГГ/Причёски/Суша/Вперёд/Афрокосички/Блонд.png"},
                    new []{"Персонажи/ГГ/Аксессуары/0/Сёрфборд/1.png", "Персонажи/ГГ/Аксессуары/0/Сёрфборд/2.png"},
                    new []{"Персонажи/ГГ/Внешность/Азиатская/Азиатская.png", "Персонажи/ГГ/Внешность/Латиноамериканская/Латиноамериканская.png", "Персонажи/ГГ/Внешность/Афроамериканская/Афроамериканская.png", "Персонажи/ГГ/Внешность/Европейская/Европейская.png"})
            }).AddTo(this);
            ...
            while (!IsDisposed) //gameloop
            {
                ...
                if (storyManifest == null) 
                {
                    ...
                    var mainScreen = new Menu.Entity(new Menu.Entity.Ctx
                    {
                        ...
                        GetText = getText,
                        GetTexture = getTexture,
                        OpenWardrobe = async (manifest) => await wardrobe.Open(manifest),
